...
//   return <Container className="flex flex-col md:flex-row gap-10 pb-10">
    
//     {product?.images && <ImageView images={product?.images} isStock={product?.stock}/>}
    
//     <div className="w-full md:1/2 flex flex-col gap-5">
...
//         />
//         <p className={`px-4 text-sm text-center inline-block py-1.5 font-semibold rounded-lg ${product?.stock === 0 ? "bg-red-100 text-red-600" : "text-green-600 bg-green-100"}`}>
