    ...
    <div className="border-t">
      <Container className="mt-5">
        ...
        <div className="flex flex-col md:flex-row gap-5 border-t border-t-shop_dark_green">
          <div
            className="md:sticky md:top-20 md:self-start md:h-[calc(100vh-160px)] scrollbar-hide
                md:overflow-y-auto md:min-w-64 pb-5 md:border-r  border-r-shop_btn_dark_green/50 "
          >
            {/* CategoryList */}
            <CategoryList
          ...
          <div className="flex-1 pt-5">
            <div className="h-[calc(100vh-160px)] overflow-y-auto pr-2 scrollbar-hide">
              {loading ? (
                <div className="p-20 flex flex-col gap-20 items-center justify-center bg-white">
