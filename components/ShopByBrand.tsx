...
const extraData=[
    {
        title: "Free DElivery",
        description: "Free Shipping Over Rs-10,000",
        icon: <Truck size={45} />
    },
     {
        title: "Free Return",
  ...
  return (
    <div className="mb-10 lg:pb-20 bg-shop_light_bg p-5 lg:p-7 rounded-md">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-2.5">
        {brands?.map((brand) => (
         <Link key={brand?._id} href={{pathname:"/shop", query:{brand: brand?.slug?.current}}} className="bg-white w-34 h-24 flex items-center justify-center rounded-md overflow-hidden hover:shadow-lg shadow-shop_dark_green/20 hoverEffect"> 
